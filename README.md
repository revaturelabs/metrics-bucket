...
The .json that is used when displaying the list of files should be overhauled into an object (or use string interpolation). The current implementation is simply ugly.
